...
//}
resolvers += Seq("maven_evaluation Maven3 Repository" at "https://bizonedev.pkgs.visualstudio.com/Demo/_packaging/maven_evaluation/maven/v1/")(Resolver.ivyStylePatterns))
